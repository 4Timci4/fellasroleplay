...
// Okunmamış başvuruları al
$applications = getApplications('unread', $limit, $offset);
$total_applications = countApplications('unread');
...
<div class="container mx-auto">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-2">
        <h1 class="text-3xl font-bold text-text-light">Okunmamış <span class="text-primary">Başvurular</span></h1>
        <span class="bg-[#00152a] text-blue-300 text-xs font-semibold px-3 py-1 rounded-lg border border-blue-500">
            ...
            <tbody class="divide-y divide-primary-dark">
                ...
                <tr class="hover:bg-[#0a0a0a] transition-colors">
                    ...
                    <td class="py-3 px-4">
                        ...
                        <?php if (isAdmin()): ?>
                        <a href="delete_application?id=<?php echo $application['id']; ?>&redirect=unread" 
    ...
    <div class="card-bg rounded-lg shadow-lg p-8 text-center border border-primary-dark">
        <i class="fas fa-envelope-open text-primary text-4xl mb-4"></i>
        <p class="text-white">Okunmamış başvuru bulunmuyor.</p>
    </div>
    <?php endif; ?>
</div>
